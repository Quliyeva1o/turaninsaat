...
const content = {
  az: {
    ...
    story: {
      ...
      desc: `Turan İnşaat komandası uzun illərdir Azərbaycanda hovuz və spa layihələrinin həyata keçirilməsində peşəkar xidmət göstərir. My Class (Yasamal), Hyatt Regency kimi tanınmış obyektlərdən tutmuş, şəxsi villaların hovuzlarına qədər — hər layihədə keyfiyyət, yenilik və müştəri məmnuniyyəti əsas prioritetimizdir.`,
    },
    references: {
      badge: "REFERANSLARIMIZ",
      title: "Tamamladığımız layihələr",
      items: [
        {
          name: "My Class",
          sub: "Yasamal – Hovuz, Cakuzi, Sauna, Türk Hamamı",
          tag: "Ticarət",
        },
        {
          name: "Hyatt Regency",
        ...
        {
          name: "Bilgəh Villası",
          sub: "Mircəlal küç. – Daşma Hovuz",
          tag: "Şəxsi",
        },
        {
          name: "Badamdar Layihəsi",
          sub: "Daşma Hovuz",
          tag: "Şəxsi",
        },
      ],
      ...
      items: [
        {
          name: "Elvin Məmmədov",
          role: "Ev sahibi",
          text: "Layihə gözlədiyimdən daha yaxşı alındı! Komanda peşəkar yanaşdı, zamanında tamamlandı.",
        },
        {
          name: "Leyla Hüseynova",
          role: "Villa sahibi",
          text: "Peşəkar yanaşma və yüksək keyfiyyət. Hovuzumuz tam arzuladığım kimi oldu.",
        },
        {
          name: "Rəşad Quliyev",
          role: "Otel direktoru",
          text: "Tam ideal nəticə əldə etdik. Müştərilərimiz hovuzdan çox razıdır.",
        },
      ],
    },
  },
  en: {
    ...
    story: {
      ...
      desc: `Our team has been delivering premium pool and spa projects for years in Azerbaijan. From renowned venues like My Class (Yasamal) and Hyatt Regency to private villa pools — quality, innovation, and customer satisfaction are our main priorities.`,
    },
    references: {
      badge: "OUR REFERENCES",
      title: "Completed projects",
      items: [
        { name: "My Class", sub: "Yasamal – Pool, Jacuzzi, Sauna, Turkish Bath", tag: "Commercial" },
        { name: "Hyatt Regency", sub: "Outdoor Pool", tag: "Hotel" },
        { name: "Bilgah Villa", sub: "Mircalal St. – Overflow Pool", tag: "Private" },
        { name: "Badamdar Project", sub: "Overflow Pool", tag: "Private" },
      ],
    },
    testimonials: {
...
const WaterWave = () => (
  <svg
    ...
    style={{ height: 60 }}
  >
    <path d="M0,40 C150,80 350,0 600,40 C850,80 1050,0 1200,40 L1200,80 L0,80 Z" fill="white" />
  </svg>
);

/* ── Main Component ── */
export default function AboutClient({ locale = "az" }: Props) {
    ...
    <main>
      ...
      >
        ...
        <div
          ...
          style={{
            width: 600, height: 600, top: -200, right: -180,
        ...
        <div className="relative max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-12 pt-20 sm:pt-28 pb-0 flex flex-col lg:flex-row items-start gap-16 lg:gap-24">
          ...
          <div className="flex-1 order-2 lg:order-1 pb-16 lg:pb-24">
            ...
            <p
              ...
              style={{ color: "rgba(196,155,99,0.7)", letterSpacing: "0.05em" }}
            >
              {t.about.slogan}
            </p>
            ...
            {/* Description — PDF mətnindən götürülmüş */}
            <p
              data-aos="fade-up"
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center mt-10">
              ...
              <div className="border-l-2 pl-6" style={{ borderColor: "rgba(196,155,99,0.4)" }}>
                ...
                {/* PDF-dəki hər iki nömrə */}
                <div className="font-bold text-[20px] mt-1" style={{ color: "#C49B63" }}>
                  <a href="tel:+994503127657">+994 50 312 76 57</a>
                </div>
                <div className="font-semibold text-[15px] mt-0.5" style={{ color: "rgba(196,155,99,0.7)" }}>
                  <a href="tel:+994557513115">+994 55 751 31 15</a>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 order-1 md:order-2 relative flex items-end w-full" style={{ maxWidth: 520 }}>
            ...
            <Image
              src={certImg}
              alt="Turan İnşaat MMC – Rəsmi Lisenziya Sertifikatı"
              width={460}
              height={560}
      ...
      {/* ─── REFERENCES SECTION — PDF-dən götürülmüş ─── */}
      <section className="bg-white border-t" style={{ borderColor: "rgba(0,168,181,0.08)" }}>
        <div className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-12 pb-20 sm:pb-28">
          {/* Header */}
          <div className="text-center mb-12">
            ...
            <h2
              className="font-extrabold text-[28px] sm:text-[36px] leading-tight"
              style={{ color: "#0A1E30" }}
            >
              {t.references.title}
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {t.references.items.map((ref, i) => (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={i * 70}
                className="relative rounded-2xl p-6 flex flex-col gap-2 group transition-all duration-300 overflow-hidden"
                style={{
                  border: "1px solid rgba(0,168,181,0.12)",
                  background: "#f7f8fa",
                  boxShadow: "0 2px 16px rgba(10,30,48,0.05)",
                }}
              >
                {/* Tag */}
                <span
                  className="inline-block self-start px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider mb-1"
                  style={{ background: "rgba(0,168,181,0.1)", color: "#00A8B5" }}
                >
                  {ref.tag}
                </span>
                <div className="font-extrabold text-[17px]" style={{ color: "#0A1E30" }}>{ref.name}</div>
                <div className="text-[13px] leading-snug" style={{ color: "#5a6a7a" }}>{ref.sub}</div>
            ...
            {t.testimonials.items.map((item, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ borderTop: "1px solid rgba(0,168,181,0.1)" }}
                >
                  <div
      ...
      {/* ─── CTA BOTTOM BAND ─── */}
      <section
        style={{ background: "linear-gradient(135deg, #0A1E30 0%, #0d2d45 100%)" }}
        className="py-16"
      >
        <div className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-12 flex flex-col sm:flex-row items-center justify-between gap-8">
          <div>
            <div className="font-extrabold text-[22px] sm:text-[28px] text-white leading-tight">
              {locale === "az"
                ? "Layihənizi bizimlə həyata keçirin"
                : "Bring your project to life with us"}
            </div>
            <p className="text-[14px] mt-2" style={{ color: "rgba(255,255,255,0.5)" }}>
              {locale === "az"
                ? "Pulsuz məsləhət üçün bu gün əlaqə saxlayın"
                : "Contact us today for a free consultation"}
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <Button text={locale === "az" ? "Əlaqə saxla" : "Contact us"} link="/contact" type={2} />
            <a
              href="tel:+994503127657"
              className="text-[18px] font-bold transition-colors hover:opacity-80"
              style={{ color: "#C49B63" }}
            >
              +994 50 312 76 57
            </a>
